...
$sql = "SELECT id,firstname,lastname,course,submitted FROM profile where  submitted='1'";
...
<th><font color='black'>Submitted</font></th>
...
echo '<td><font color="black">' . $row['submitted'] . '</font></td>';
